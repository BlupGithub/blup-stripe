...
import 'package:blup_stripe/src/client.dart';
import 'package:blup_stripe/src/resources/checkout_session.dart';
  ...
  group('CheckoutSessionResource', () {
    test('properly decodes all values', () async {
      final request = CreateCheckoutSessionRequest(
        ...
        subscriptionData: SubscriptionData(trialPeriodDays: 3), currency: '',
      );
