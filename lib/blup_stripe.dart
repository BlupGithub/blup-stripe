...
import 'package:blup_stripe/src/resources/subscription_schedule.dart';
...
class Stripe {
  ...
  /// Custom made billing session
  final BillingSessionResource billingSession;

  /// Custom made invoice session
  final InvoiceResource invoiceSession;
  ...
  Stripe.withClient(this.client)
      : checkoutSession = CheckoutSessionResource(client),
        billingSession = BillingSessionResource(client),
        invoiceSession = InvoiceResource(client),
